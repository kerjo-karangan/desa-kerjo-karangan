...
export default function Transparansi({ activeSubMenu }: { activeSubMenu?: string }) {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20">
      ...
      {/* 1. GRAFIK APBDES (Tampil jika trans-apbdes atau transparansi induk aktif) */}
      {(!activeSubMenu || activeSubMenu === "transparansi" || activeSubMenu === "trans-apbdes") && (
        <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border-t-4 border-yellow-400 mb-8">
      ...
      {/* 2. REALISASI DANA */}
      {(!activeSubMenu || activeSubMenu === "transparansi" || activeSubMenu === "trans-realisasi") && (
        <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 border-t-4 border-green-600 mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 bg-green-50 p-6 rounded-2xl border border-green-200 shadow-inner h-fit">
      ...
      {/* 3. DOKUMEN REGULASI */}
      {(!activeSubMenu || activeSubMenu === "transparansi" || activeSubMenu === "trans-regulasi") && (
                ...
                <tbody>
                  {daftarRegulasi.map((docItem) => (
                    <tr key={docItem.id} className="border-b hover:bg-blue-50 transition-colors">
                      ...
                      <td className="py-4 px-4"><div className="font-bold text-gray-800 text-base leading-snug mb-2">{docItem.judul}</div><a href={docItem.link} target="_blank" className="text-xs font-bold text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-1"><span>🔗</span> Buka Tautan</a></td>
                  ...
                  {daftarRegulasi.length === 0 && (
                    <tr><td colSpan={3} className="text-center py-8 text-gray-500">Belum ada dokumen yang diunggah.</td></tr>
                  )}
                </tbody>
              </table>
            </div>
